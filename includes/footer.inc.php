<footer>
    <div class="topFooter">
        <div class="container text-center">
            <h4 class="w700">
                ...
                <path fill-rule="evenodd" d="M13.5 8.5a.5.5 0 0 1 .5.5v3a2.5 2.5 0 0 1-2.5 2.5H8a.5.5 0 0 1 0-1h4.5A1.5 1.5 0 0 0 13 12V9a.5.5 0 0 1 .5-.5z"/>
                <path d="M6.5 14a1 1 0 0 1 1-1h1a1 1 0 1 1 0 2h-1a1 1 0 0 1-1-1z"/>
                </svg> If you have any question please call us 0117 662 661
            </h4>
        </div>
        <div class="container mt-5">
            <div class="row align-items-center">
                <div class="col-12 col-md-3">
                    <img src="<?php echo HTTP_PATH ?>img/logo.png" class="img-fluid" alt="">
                </div>
                <div class="col-12 col-md-9 border-left border-dark">
    ...
    <div class="bottomFooter mt-3">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12 col-md-9">
                    <h6 class="text-uppercase w700">My Account</h6>
                    <ul class="nav">
                        <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#">Retrun & Exchange</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">Shipping & Delivery</a>
                        </li>
                    </ul>
                    <h6 class="text-uppercase mt-4 w700">Quick Links</h6>
                    <ul class="nav">
                        <li class="nav-item">
                            <a class="nav-link" href="#">Stor Locations</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">My Account</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="#">Orders Tracking</a>
                        </li>
                        <li class="nav-item">
                ...
                <div class="col-12 col-md-3 border-left border-light">
                    <h6 class="text-uppercase w700">Quick Links</h6>
